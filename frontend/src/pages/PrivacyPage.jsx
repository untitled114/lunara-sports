...
const sections = [
  ...
  {
    title: '4. Analytics',
    body: 'Lunara Sports does not currently use any analytics, tracking, or telemetry services. No usage data, page views, click events, or behavioral information is collected or transmitted to any server.', // design-check-allow: legal disclosure naming the absence of telemetry services
  },
  {
    ...
    <div className="animate-intel">
      ...
      <div className="relative mb-8 rounded-lg border border-border bg-surface-card p-8 sm:p-12">
        <div className="relative z-10 flex items-center gap-6">
          ...
          <div>
            <h1 className="t-title text-text-1">Privacy Policy</h1>
            <p className="t-label text-text-3 mt-2">Last updated: February 19, 2026</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-border bg-surface-card p-6 sm:p-10 space-y-10">
        {sections.map((section, i) => (
          <div key={i} className="animate-intel" style={{ animationDelay: `${i * 0.05}s` }}>
            ...
            <p className="t-body text-text-2">{section.body}</p>
